...
function Aboutme() {
    const [transform, setTransform] = useState("../src/images/mikel1.jpg");

    const changePhoto = () => {
        setTransform(prevPhoto => prevPhoto === "../src/images/mikel1.jpg" ? "../src/images/mikel2.jpg" : "../src/images/mikel1.jpg")
    }
